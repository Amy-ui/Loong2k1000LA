...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        parser.add_argument('--source', type=str,
                            default='rtsp://192.168.31.183:8554/unicast', help='source')
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "智能消防小车"))
        self.pushButton_img.setText(_translate("MainWindow", "智能巡线"))
        self.pushButton_camera.setText(_translate("MainWindow", "火源检测"))
        self.pushButton_video.setText(_translate("MainWindow", "打开摄像头"))
    ...
    def button_camera_open(self):
        if not self.timer_video.isActive():
            # 默认使用第一个本地camera
            flag = self.cap.open(r'C:\Users\lele\Desktop\loong\video\line.mp4')
            if flag == False:
                QtWidgets.QMessageBox.warning(
